...
*/
UINT64 GetDynamicActiveProcessOffset()
{
    ULONG ActiveProcessOffset = 0;//1909
    ULONG KiProcessList = 0;//1909
...
VOID UnlinkActiveProcessLists(PEPROCESS PE)
{
    ...
    UINT64 Offset = GetDynamicActiveProcessOffset();
    LIST_ENTRY* ActiveProcessLink = (LIST_ENTRY*)((ULONG64)PE + Offset);
